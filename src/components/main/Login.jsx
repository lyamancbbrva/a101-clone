            ...
            <Dialog as="div" className="relative z-10" onClose={setOpen}>
                ...
                <div className="fixed inset-0 z-10 overflow-y-auto">
                    <div className="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-3xl bg-white px-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[450px] sm:pt-10">
                                <div
                                    onClick={() => {
                                        setOpen(false)
                                ...
                                <div className="mt-5 sm:mt-4 justify-center gap-3 flex flex-col">
                                    <input type="text" name="" id="" placeholder='Adınız...' className='w-full outline-none rounded-full border p-4 sm:text-sm' />
                                    <input type="password" name="" id="" placeholder='Şifreniz...' className='w-full outline-none rounded-full border p-4 sm:text-sm' />
                                    <button
                                        type="button"
                                ...
                                <div className='py-8 flex items-center gap-2'>
                                    ...
                                    <p className='text-xs text-[#444]'>Doğrulama süreçleri kapsamındaki kişisel veri işleme faaliyetine ilişkin aydınlatma metni için <a href="" className='text-[#00BAD3]'>tıklayın</a>    .</p>
                                </div>
                            </Dialog.Panel>
                        </Transition.Child>
                    </div>
