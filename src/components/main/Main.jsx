    ...
    return (
        <div className="bg-[#F3F6FA] min-h-[30vh]">
            ...
            >
                ...
                <Highlights basket={basket} setBasket={setBasket} />
                <Link to={''} className="block aldin1  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block aldin2  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block aldin3  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block aldin4  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block aldin5  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block iphone  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block samsung  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block xiaomi  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block tefal  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block stanley  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block skechers  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[327h] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block crocs  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block kamp  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block mobilya  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
                <Link to={''} className="block ceyiz  overflow-hidden 550:h-[40vh] sm:h-[50vh] lg:h-[27vh] w-full h-[30vh] rounded-2xl md:h-[25vh] my-5 xl:h-[40vh] "></Link>
            </div>
        </div>
    )
}
